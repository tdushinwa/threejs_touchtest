...
class drawing{
    ...
    // 四角の描画関数
    public squareMesh(x: number, y: number, z: number, size: number, color: any):void{
    ...
    // 線の描画関数
    public lineMesh(
        x1: number, y1: number, z1: number, x2: number, y2: number, z2: number, color: any
    ):void{
